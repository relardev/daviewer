...
// end include: /tmp/tmph_rh1uup.js
// include: /tmp/tmp2cjuwja6.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp2cjuwja6.js
// include: /tmp/tmpvfforsv_.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpvfforsv_.js
...
var ASM_CONSTS = {
  1278416: () => { if (document.fullscreenElement) return 1; },  
 1278462: () => { return document.getElementById('canvas').width; },  
 1278514: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1278582: () => { document.exitFullscreen(); },  
 1278609: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1278682: () => { if (document.fullscreenElement) return 1; },  
 1278728: () => { return document.getElementById('canvas').width; },  
 1278780: () => { return screen.width; },  
 1278805: () => { document.exitFullscreen(); },  
 1278832: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1278965: () => { return window.innerWidth; },  
 1278991: () => { return window.innerHeight; },  
 1279018: () => { if (document.fullscreenElement) return 1; },  
 1279064: () => { return document.getElementById('canvas').width; },  
 1279116: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1279184: () => { if (document.fullscreenElement) return 1; },  
 1279230: () => { return document.getElementById('canvas').width; },  
 1279282: () => { return screen.width; },  
 1279307: () => { return window.innerWidth; },  
 1279333: () => { return window.innerHeight; },  
 1279360: () => { if (document.fullscreenElement) return 1; },  
 1279406: () => { return document.getElementById('canvas').width; },  
 1279458: () => { return screen.width; },  
 1279483: () => { document.exitFullscreen(); },  
 1279510: () => { if (document.fullscreenElement) return 1; },  
 1279556: () => { return document.getElementById('canvas').width; },  
 1279608: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1279676: () => { document.exitFullscreen(); },  
 1279703: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1279761: () => { return screen.width; },  
 1279786: () => { return screen.height; },  
 1279812: () => { return window.screenX; },  
 1279839: () => { return window.screenY; },  
 1279866: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1279919: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1279990: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1280047: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1280303: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1280374: () => { if (document.fullscreenElement) return 1; },  
 1280420: () => { return window.innerWidth; },  
 1280446: () => { return window.innerHeight; },  
 1280473: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
...
var _web_is_text_input_focused = Module['_web_is_text_input_focused'] = createExportWrapper('web_is_text_input_focused', 0);
